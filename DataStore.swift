...
class DataStore {
    ...
    func fetchPirate () {
        let fetch = NSFetchRequest(entityName: "Pirate")
        
        let createdAtSort = NSSortDescriptor(key: "name", ascending: true)
        fetch.sortDescriptors = [createdAtSort]
        
        do {
            self.pirates = try self.managedObjectContext.executeFetchRequest(fetch) as! [Pirate]
...
//    Don't need this?
//    func fetchShips () {
//        let fetch = NSFetchRequest(entityName: "Ship")
//        
//        let createdAtSort = NSSortDescriptor(key: "name", ascending: true)
//        fetch.sortDescriptors = [createdAtSort]
//        
//        do {
//            self.ships = try self.managedObjectContext.executeFetchRequest(fetch) as! [Ship]
//        } catch let nserror as NSError {
//            print (nserror)
//        }
//        
...
//    }
    ...
    func generateTestData() {
        ...
        engineOne.propulsion = "Electric"
        
        shipOne.engines = engineOne
        pirateOne.ships = [shipOne]
